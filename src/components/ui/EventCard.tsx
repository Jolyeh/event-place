  ...
  if (variant === "compact") {
    return (
      <motion.div
        ...
        className="p-3 rounded-2xl bg-base-200 border border-primary/8 hover:border-primary/25 transition-all duration-300 cursor-pointer group"
      >
        <Link  className="flex items-center gap-4" href={`/evenements/${event.id}`}>
